...
#leaves i:before {
  ...
  background: linear-gradient(to right, rgba(192, 192, 192, 1), #616161);
  z-index: 1;
}
...
#leaves i:nth-of-type(4n + 1) {
  background: linear-gradient(to bottom right, #f5f5f5, #616161);
}
...
@-webkit-keyframes falling {
  0% {
    -webkit-transform: translate3d(-350, 0, 0) rotate(0deg);
  }

  100% {
    -webkit-transform: translate3d(300px, 700px, 0) rotate(90deg);
    opacity: 0;
  }
}
...
@-webkit-keyframes falling2 {
  0% {
    -webkit-transform: translate3d(400, 0, 0) rotate(90deg);
  }
